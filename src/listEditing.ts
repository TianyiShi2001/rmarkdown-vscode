...
function onMoveLineUp() {
  return commands.executeCommand("editor.action.moveLinesUpAction").then(() => fixMarker());
}
...
function onCopyLineUp() {
  return commands.executeCommand("editor.action.copyLinesUpAction").then(() => fixMarker());
}

function onCopyLineDown() {
  return commands.executeCommand("editor.action.copyLinesDownAction").then(() => fixMarker());
}
